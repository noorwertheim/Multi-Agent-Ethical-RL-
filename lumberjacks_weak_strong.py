''' Lumberjacks version without any ethics, but with the weak and strong implementation.
Used to test the performance of the lumberjacks when there is no ethics to compensate the bahavior. 
Also used to determine the right weak_percentage. 
agent 0 is strong
agent 1 is weak
'''
