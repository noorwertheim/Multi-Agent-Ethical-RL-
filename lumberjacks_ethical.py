''' Lumberjacks version with ethics, and weak and strong agent
...
class Lumberjacks(gym.Env):
    ...
    def __init__(self, grid_shape: Coordinates = (5, 5), n_agents: int = 2, n_trees: int = 18,
                 ...
                 step_cost: float = -1, tree_cutdown_reward: float = 10, max_steps: int = 150, weak_percentage: float = 0.5, normative_reward: float = -10, evaluative_reward: float = 10, w0: float = 1, we: float = 0.9):
        assert 0 < n_agents
